...
$(function(){
  ...
  $('.product-detalis__slide-bottom--list').slick({
    slidesToShow: 4,
    slidesToScroll: 4,
    infinite: true,
});
//------------------
  ...
  $('.product-detalis__tabs-top-link').on('click',function(e){
    e.preventDefault();
    $('.product-detalis__tabs-top-link').removeClass('product-detalis__tabs-top-link--active');
     $(this).addClass('product-detalis__tabs-top-link--active');

     $('.product-detalis__tabs-content-item').removeClass('product-detalis__tabs-content-item--active');
     $($(this).attr('href')).addClass('product-detalis__tabs-content-item--active');
  });

  // slider for product details------------------
  $('.product-detalis__slide-asside').slick({
    asNavFor: '.product-detalis__slide-big',
    focusOnSelect: true,
    slidesToShow: 3,
    slidesToScroll: 1,
    vertical: true,
  ...
  $('.product-detalis__slide-big').slick({
    asNavFor: '.product-detalis__slide-asside',
    draggable: false,
    arrows: false,
    fade: true
  });
 ...
 $('.select-category, .product-one__item-num').styler();
 //-----------------------------------------------------
...
//filter price
  ...
  // var mixer = mixitup('.products__mix-cards');
...
// ------mixtup------
    ...
    //   initializeClock('promo__clock', deadline);
     ...
     // start yandex maps https://www.youtube.com/watch?v=QkfUqb2XFRw варіант для  одного або кылькох маркерыв безциклу ы кластерів маркера
